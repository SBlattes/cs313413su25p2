...
public class TestList {
  ...
  public void testSizeNonEmpty() {
    ...
    list.add(77);
    assertFalse(list.isEmpty()); //List is no longer empty
    assertEquals(1, list.size()); //1 element in the list
    assertEquals(77, list.get(0).intValue()); //Element at index 0 is 77.
  }
